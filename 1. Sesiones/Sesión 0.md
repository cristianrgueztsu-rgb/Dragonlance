...
- [Rovina](obsidian://open?vault=Obsidian%20Vault&file=Dragonlance%2FPersonajes%2FROVINA) es una maga de capa roja encargada de dar la bienvenida a todo el mundo. Les introduce al lugar y explica lo que está ocurriendo.
- [Rovina](obsidian://open?vault=Obsidian%20Vault&file=Dragonlance%2FPersonajes%2FROVINA) los lleva a una puerta y les cuenta las reglas Pag 47 "Rules of the trial"
...
- Manejar el resto con la pag 47
- Una vez salen, los recibe Rovina, felicita y le da a ainhoa:
	- Un libro de hechizos decorado con el simbolo de la organizacion de los magos(enseñar el libro pag46). Este libro es para quie haga con el lo que quiera, escribir descubrimientos, diario, lo que sea
	- Un pergamino ornamentado. Esto será para el siguiente mago que que liderará la siguiente prueba. Un mago de túnica negra llamado [Wyhan](obsidian://open?vault=Obsidian%20Vault&file=Dragonlance%2FPersonajes%2FWYHAN) que reside en la ciudad de Kalaman. (Énfasis en NO DEBES ABRIR EL PERGAMINO; ES PARA WYHAN SOLAMENTE)
